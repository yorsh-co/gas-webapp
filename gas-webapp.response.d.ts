...
declare class JsonResponse {
  readonly payload: SuccessPayload;
  constructor(payload: SuccessPayload);
}
declare class HtmlResponse {
  readonly output: GoogleAppsScript.HTML.HtmlOutput;
  constructor(output: GoogleAppsScript.HTML.HtmlOutput);
}
